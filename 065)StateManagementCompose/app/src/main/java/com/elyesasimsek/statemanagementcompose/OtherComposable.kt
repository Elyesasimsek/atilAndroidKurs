package com.elyesasimsek.statemanagementcompose
...
fun OtherScreen() {
    Surface(
        ...
        Column(modifier = Modifier.fillMaxSize(),
            ...
            Image(bitmap = ImageBitmap.imageResource(id = R.drawable.luffy), contentDescription = "Luffy")
            ...
            Image(painter = ColorPainter(Color.Black), contentDescription = null, modifier = Modifier.size(50.dp, 50.dp))
        }
    }
}